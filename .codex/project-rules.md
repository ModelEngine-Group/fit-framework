...
9. **结尾签名**
   - [ ] 必须添加：`🤖 Generated with [Codex CLI](https://developers.openai.com/codex/cli)`
...
本项目配置了以下自定义命令，位于 `.codex/commands/` 目录：
...
- [x] requirement-analysis (codex, 2026-01-03)
- [x] technical-design (codex, 2026-01-03)
- [x] implementation (codex, 2026-01-04)
- [x] code-review (codex, 2026-01-04)
- [ ] finalize (待执行)
```
...
3. **准确记录**：
   ...
   - `assigned_to` 必须是你的名字（codex / chatgpt / gemini 等）
