...
public interface ToolRepository {
     ...
     * 添加工具。
     *
     * @param tool 表示待增加的工具信息的 {@link DefaultToolEntity}。
     */
    @Genericable(id = "modelengine.fel.tool.add")
    void addTool(DefaultToolEntity tool);
     ...
     * @return 表示工具的 {@link DefaultToolEntity}。
     */
    @Genericable(id = "modelengine.fel.tool.get")
    DefaultToolEntity getTool(String namespace, String toolName);

    /**
     * 获取命名空间下的所有工具。
     *
     * @param namespace 表示工具命名空间的 {@link String}。
     * @return 表示工具的 {@link List}{@code <}{@link DefaultToolEntity}{@code >}。
     */
    @Genericable(id = "modelengine.fel.tool.list")
    List<DefaultToolEntity> listTool(String namespace);
}
